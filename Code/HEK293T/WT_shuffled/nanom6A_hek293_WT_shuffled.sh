...
predict_sites=predict_sites_shuffled_WT_larger_KO.py

## Setup Nanom6A models
models=/path/to/nanom6A/models

## Setup required folders
nanom6A_step1=/path/to/nanom6A/step1/results/WT_shuffled/

nanom6A_step2=/path/to/nanom6A/step2/results/WT_shuffled/
